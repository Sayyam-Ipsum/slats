        ...
        <div class="card mb-3">
            <div class="card-header bg-light">
                <div class="row">
                    <div class="col-md-6">
                        <p class="text-right">
                            <button accesskey="b" class="btn btn-falcon-default btn-sm me-1 mb-1" id="bgback">Back</button>
                            <?php echo anchor('return_purchases/preview/' . $this->Transaction->get_field('id'), 'Print', 'accesskey="p" class="btn btn-falcon-default btn-sm me-1 mb-1"  id="print"') ?>
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            <label class="form-label"
                                   for="auto_no">Return Purchase #</label>
            ...
            <div class="card-footer border-top border-200 d-flex flex-between-center">
                <div class="d-flex align-items-center">
                    <?php echo form_submit('submitBtn', $this->lang->line('save'), 'class="btn btn-falcon-default btn-sm me-1 mb-1" accesskey="s"'), ' ', form_reset('reset', $this->lang->line('reset'), 'class="btn btn-link"') ?>
                </div>
            </div>
            <?php
            echo form_close();
