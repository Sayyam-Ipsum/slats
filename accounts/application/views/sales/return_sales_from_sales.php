...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="auto_no">Return Sales #</label>
			<div class="col-sm-8">
				<?php
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="TVA">TVA</label>
			<div class="col-sm-8">
				<?php echo form_dropdown('trans[TVA]', $TVA, $trans['TVA'], 'id="TVA1" class="form-control form-control-sm"')
				?>
				<div id="error_TVA" style="text-align:center" onclick="document.getElementById('error_TVA').style.display = 'none'"></div>
			</div>
		</div>
	</div>
	<div class="col-sm-8">
