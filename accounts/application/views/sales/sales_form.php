...
<div class="row g-0">
    <div class="col-lg-12 pe-lg-2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="text-right">
                            ...
                            <?php echo anchor('sales/exit/' . $this->Transaction->get_field('id'), 'Exit', 'class="btn btn-falcon-default btn-sm me-1 mb-1"  id="bgback"') ?>
                            <?php echo anchor('delivery_notes/preview/' . $this->Transaction->get_field('id'), 'Delivery Note', 'accesskey="b" class="btn btn-falcon-default btn-sm me-1 mb-1"  id="delivery_note"') ?>
                            <?php echo anchor('sales/preview/' . $this->Transaction->get_field('id'), 'Print', 'accesskey="p" class="btn btn-falcon-default btn-sm me-1 mb-1"  id="print"') ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="mb-3">
                            ...
                            <input type='hidden' value='0' name='trans[delivered]'>
                            <input name="trans[delivered]" value='1' type="checkbox" style="transform: scale(1.5);"
                                   id="delivered"
                                   class="input.i-delivered" <?php echo($delivered == 1 ? 'checked' : ''); ?>>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <div class="table-responsive scrollbar fs--1">
                                <table class="table table-bordered table-striped mb-0 fs--1 overflow-hidden display compact" style="width:100%"
                                       id="trans_items_table">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            <label class="form-label" for="final_profit">Profit</label>
                            <?php
                            echo form_input('trans[final_profit]', '', 'id="final_profit" class="form-control form-control-sm" readonly="true"')
                            ?>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 table-responsive scrollbar fs--1">
                        <table class="table table-striped table-bordered border-bottom overflow-hidden">
                            <thead style="background-color: #D13131; color: white">
                            <tr>
                                <td colspan="10">
                                    <center><b>Return Sales</b></center>
                                </td>
                            </tr>
                            <tr class="danger">
                                <th>#</th>
                    ...
                    <div class="col-md-12 table-responsive fs--1">
                        ...
                        <table class="table table-striped table-bordered border-bottom" id="activityitemTbl">
                            <thead style="background-color: #D13131; color: white">
                            <tr class="danger">
