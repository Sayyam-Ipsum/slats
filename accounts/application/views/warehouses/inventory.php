        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div id="msg" class="alert alert-success" style="text-align:center"
                     onclick="document.getElementById('msg').style.display = 'none'">
                    <strong><?php echo $this->session->flashdata('message_inventory') ?></strong>
                </div>
                <?php } ?>
                <?php if ($this->session->flashdata('erorr_inventory')) { ?>
                    <div id="erorr_inventory" class="alert alert-danger" style="text-align:center"
                         onclick="document.getElementById('erorr_inventory').style.display = 'none'">
                ...
                <div class="mb-1">
                    <div <?php echo ($total_permission == '0') ? 'hidden' : ''; ?>>
                        ...
                        <input type="text" name="tot" value="<?php echo $tot ?>"
                               class="form-control form-control-sm" id="tot"
        ...
        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-1">
                                    <label class="form-label"
                                           for="artical_number_alt">Alternative</label>
                    ...
                    <div class="card-footer border-top border-200 d-flex flex-between-center">
                        <div class="d-flex align-items-center">
                            <button name="search" type="submit"
                                    class="btn btn-falcon-default btn-sm me-1 bt-link btn-sm"
            ...
            <div class="col-md-8">
                <div class="card mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-1">
                                    ...
                                    <input type="text" list="shelfs" id="filter_shelf" name="shelf" value=""
                    ...
                    <div class="card-footer border-top border-200 d-flex flex-between-center">
                        <div class="d-flex align-items-center">
                            <button name="search" type="submit" id="filter"
                                    class="btn btn-falcon-default btn-sm me-1 bt-link" title="Filter"><i
                                        class="fas fa-filter"></i></button>

                            <button type="button" name="reset_filters" id="reset_filters" title="Refresh"
                                    class="btn btn-falcon-default btn-sm me-1 bt-link btn-sm btn-small-design"><i
                                        class="fas fa-redo"></i></button>

                            <button name="adjust" type="button" id="adjust" title="Adjust Minus"
                                    class="btn btn-falcon-default btn-sm me-1 bt-link btn-sm"><i
                                        class="fas fa-minus"></i></button>

                            <button name="adjust_plus" type="button" id="adjust_plus" title="Adjust Plus"
                                    class="btn btn-falcon-default btn-sm me-1 bt-link btn-sm"><i
                                        class="fas fa-plus"></i>
                            </button>

                            <button name="adjust_shelf" type="button" id="adjust_shelf" title="Clear Shelf"
                                    class="btn btn-falcon-default btn-sm me-1 bt-link btn-sm"><i
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered mb-0 fs--1 display compact" style="width:100%" id="warehousesTbl" data-num-rows="<?php echo $this->Warehouse->get('paginationTotalRows') ?>">
                            ...
                            <tr>
                                ...
                                <th class="text-center" data-no-search="0" style="width: 40px"><?php echo $this->lang->line('actions') ?></th>
                            </tr>
                            </thead>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="col-form-label"
                                       for="account_type">Confirm</label>
