                ...
                <div class="row">
                    <div class="col-md-6">
                        <p id="listbtn">
                            <?php if ($this->Transaction->get_field('id')) { ?>
                                <?php echo anchor('orders/exit/' . $this->Transaction->get_field('id'), 'Exit', 'class="btn btn-falcon-default btn-sm me-1 mb-1"  id="bgback"') ?>
                            <?php } else { ?>
                                <?php echo anchor('orders/index/', 'Exit', 'class="btn btn-falcon-default btn-sm me-1 mb-1"  id="bgback"') ?>
                            <?php } ?>
                            ...
                            <?php echo anchor('accounts/customer_info_preview/' . $this->Transaction->get_field('id'), 'Customer Info', 'accesskey="p" class="btn btn-falcon-default btn-sm me-1 mb-1"  id="customer_print"') ?>
                    ...
                    <div class="col-md-6">
                        <?php if ($this->Transaction->get_field('id')) { ?>
                            ...
                            <h6>Created on: <span style="color: red;"><b><?php echo $created_on ?></b></span> by:
                                <span style="color: red;"><b><?php echo $user_add ?></b></span> & Edited by: <span
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group-addon">
                                <button type="button" id="add_acc_modal"><i
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input name="trans[account2_id]"
                                   value="<?php echo $this->Transaction->get_field('account2_id') ?>" id="account2_id"
                                   type="hidden"/>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <?php echo form_textarea('trans[model]', $this->Transaction->get_field('model'), 'id="model" class="form-control form-control-sm" style="height:150px;"') ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label"
                                   for="employee_id">Select Employee</label>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label"
                                   for="delivery_type">Delivery Type</label>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label"
                                   for="driver_id">Select Driver</label>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label"
                                   for="tracking_number">Tracking #</label>
                            <?php echo form_input('trans[tracking_number]', $this->Transaction->get_field('tracking_number'), 'id="tracking_number" class="form-control form-control-sm"') ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label"
                                   for="itemLookup">Select Item</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive scrollbar mb-2">
                                <table class="table table-bordered mb-0 fs--1 display compact" style="width:100%" id="transItemsTbl">
                                    ...
                                    <tr class="danger">
                                        ...
                                        <th>Brand</th>
                                        <th style="width: 150px">Artical Nb</th>
                                        <th>Supplier</th>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="mb-3">
                                <label class="form-label"
                                       for="sub_total">Subtotal</label>
                                <?php echo form_input('trans[sub_total]', '', 'id="sub_total" class="form-control form-control-sm" readonly="true"') ?>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                <label class="form-label"
                                       for="delivery_charge">Delivery Charge</label>
                                <?php
            ...
            <div class="card-footer border-top border-200 d-flex flex-between-center">
                <div class="d-flex align-items-center">
                    ...
                    <?php echo form_submit('submitBtn', "Save & Exit", 'class="btn btn-danger me-1 mb-1"') ?>
                </div>
            </div>
        </div>
        <?php
