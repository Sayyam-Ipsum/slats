...
<input name="transItems[<?php echo $x ?>][item_price]" value="<?php echo $transItem['item_cost'] ?>" id="mvt_type" type="text" class="d-none i-item_price" />
...
<td><?php echo form_dropdown('transItems['.$x.'][warehouses]',$warehouses_list, $warehouse[$x], 'id="warehouses" class="form-control form-control-sm i-warehouse"')
?></td>
<td><?php echo form_dropdown('transItems['.$x.'][shelfs]', $shelf_list[$x] ,$shelf[$x], 'id="shelfs" class="form-control form-control-sm i-shelf"')
?></td>
...
<td><input name="transItems[<?php echo $x ?>][price]" value="<?php echo $transItem['price'] ?>" id="price" type="text" class="form-control form-control-sm i-price" /></td>
<td class="i-subtotal"></td>
<td><input name="transItems[<?php echo $x ?>][discount]" value="<?php echo $transItem['discount'] ?>" id="discount" type="text" class="form-control form-control-sm i-discount" /></td>
